      ...
      <Paper className={classes.paper}>
        ...
        >
          <FormControl margin="normal" required fullWidth>
            ...
            <Input type="email" onChange={this.onChange}  id="email" name="Mail" autoComplete="email" autoFocus />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
        ...
        {this.state.error &&
        <CustomizedSnackbars open={this.state.error} variant="error" text="error msg"/>
        }
      </Paper>
    </main>
  );
